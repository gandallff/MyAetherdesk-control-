...
2. **`[2] BULUTA YAYINLA (DEPLOY)`**: Önce GitHub (`gandalff/AetherDesk`) reposuna yükleme yapar, ardından Vercel (`https://aetherdesk-saas-portal-nine.vercel.app`) adresine yayınlar.
...
- **Vercel Canlı Adresi**: **[https://aetherdesk-saas-portal-nine.vercel.app](https://aetherdesk-saas-portal-nine.vercel.app)**
