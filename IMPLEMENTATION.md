...
2. **`[2] BULUTA YAYINLA (DEPLOY)`**: Önce GitHub (`gandalff/AetherDesk`) reposuna yükleme yapar, ardından Vercel (`https://frontend-ecru-beta-82.vercel.app`) adresine yayınlar.
...
- **Vercel Canlı Adresi**: **[https://frontend-ecru-beta-82.vercel.app](https://frontend-ecru-beta-82.vercel.app)**
