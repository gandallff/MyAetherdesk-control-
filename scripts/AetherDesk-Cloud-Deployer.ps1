...
$txtLog.Text = "[INFO] AetherDesk Cloud Deployer Hazir.`r`nCanli GitHub: https://github.com/gandallff/MyAetherdesk-control-`r`nCanli Vercel: https://my-aetherdesk-control.vercel.app`r`n"
...
$btnVercel.Add_Click({
    ...
    Set-Location "$rootDir"
    Write-Log "✓ Vercel Canli Yayin Guncellendi! (https://my-aetherdesk-control.vercel.app)"
...
$btnAll.Add_Click({
    ...
    Write-Log "🎉 VERCEL CANLI ADRES: https://my-aetherdesk-control.vercel.app"
